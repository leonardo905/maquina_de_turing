...
//variables que ayudan en la ubicacion y el movimiento de la cinta
var coordenada = 0;
var posicion=960;
//selectores para asignar a la cinta
var padre = $("#padre");
var cinta_inicial= padre.html();

//variables para el tiempo de ejecucion de la cinta
var tiempo;
var casilla;
var estado_qx;
//div de los botones y el input
var input = $(".input_button");
var botones = $(".buttons");


//para validar la entrada al input
...
function cambiar_a_por_b(){
    ...
    estado_qx = "q1";
    tiempo = setInterval(function(){comprobar_regla();} , 2000);
